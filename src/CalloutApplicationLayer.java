...
//                    .getRegistrationNumber() + "\n" + Callout.getName() + "\n" + Callout.getAddress();
    ...
    //currently just returns the first hospital with a free ambulance in table, full implementation with location/maps integration could calculate distance to patient
    public int getClosestAvailableHospital(String address){
        return dataLayer.getClosestAvailableHospital();
