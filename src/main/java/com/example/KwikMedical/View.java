...
public class View
{
	...
	public static void main(String[] args)
	{
		...
		Patient patient= appLayer.getPatient(1);

		appLayer.addCallout(patient.getRegistrationNumber(),"incident",appLayer.getCallInformation(),"address","patientCondition");
	 ...
	 */
	private static void addCallout() throws IOException
	{
		...
		Patient patient= appLayer.getPatient(registrationNumber);
